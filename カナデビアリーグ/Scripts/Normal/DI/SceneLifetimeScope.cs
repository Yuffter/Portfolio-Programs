...
namespace MinutesGame.Normal.DI {
    public class SceneLifetimeScope : LifetimeScope
    {
        ...
        {
            builder.RegisterEntryPoint<MinutesGame.Normal.EntryPoint.GameEntryPoint>(Lifetime.Singleton)
                .AsSelf();
            builder.RegisterComponentInHierarchy<MinutesNormalMiniGameSystemFacade>().AsImplementedInterfaces().AsSelf();
